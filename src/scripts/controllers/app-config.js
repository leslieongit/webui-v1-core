...
app.config(function (
  ...
  $routeProvider
    ...
    .when("/register/confirm/:validation_token?", {
    ...
    .when("/explore/category/:category_alias?", {
      // Campaign exploration page
      templateUrl: "views/templates/explore.html",
      controller: "ExploreCtrl",
      title: "Explore",
    ...
    // })
    .when("/campaign-setup/:campaign_id", {
      // Campaign edit (creation continued)
      templateUrl: "views/templates/campaign-setup.html",
      controller: "CreateCampaignCtrl",
      title: "campaign_step_detail_page_title",
    })
    .when("/campaign-widget/:campaign_id", {
      // Widget setup (creation continued)
      templateUrl: "views/templates/campaign-widget.html",
      controller: "WidgetCtrl",
      title: "campaign_step_widget_page_title",
    })
    .when("/campaign-setup", {
      // Campaign setup (creation continued)
      templateUrl: "views/templates/campaign-setup.html",
      controller: "CreateCampaignCtrl",
      title: "Campaign Setup",
    })
    .when("/profile-setup/:campaign_id", {
      // Profile setup (creation continued)
    ...
    .when("/story/:campaign_id", {
      // This will only be used if campaign description field is enabled on step 3
      templateUrl: "views/templates/rewards.html",
      controller: "CreateCampaignCtrl",
      title: "campaign_step_reward_page_title",
    })
  ...
  $sceDelegateProvider.resourceUrlWhitelist(["self", CDN.APP_URL]);

  var calendar_translation_error = function () {
    $.get(
      "views/translation/" + LANG.DEFAULT_LANG + "/calendar.json",
      function (data) {
        ...
        $provide.value("$locale", {
          DATETIME_FORMATS: {
            ...
            ERANAMES: [data.eraname_BC, data.eraname_AD],
            ERAS: [data.era_BC, data.era_AD],
